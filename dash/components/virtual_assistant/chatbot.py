...
HARDCODED_EMAIL = "youremail@mail.com"
...
def handle_hugchat_logic(email, password, user_message):
    ...
    # handle exceptions (like login failure, API errors, etc.)
        ...
        return "Sorry, I couldn't process your request. Probably because Minh's credential is temporarily expired or " \
               "wrong! Please let him know via mnguyen0226@vt.edu"
