            ...
            html.Div(
                [
                    html.Div(
                        [
                            html.Img(
                                src="https://images.unsplash.com/photo-1614850523425-eec693b15af5?q=80&w=1470&auto"
                                    "=format&fit=crop&ixlib=rb-4.0.3&ixid"
                    ...
                    dbc.Col(
                        [
                            dbc.Card(
                                [
                                    dbc.CardImg(
                                        src="https://www.investopedia.com/thmb/bfHtdFUQrl7jJ_z-utfh8w1TMNA=/1500x0"
                                            "/filters:no_upscale():max_bytes(150000):strip_icc("
                                            ")/houses_and_land-5bfc3326c9e77c0051812eb3.jpg",
                                        top=True,
                                        style={
                                            "opacity": 0.18,
                                            "height": "200px",
                    ...
                    dbc.Col(
                        [
                            dbc.Card(
                                [
                                    dbc.CardImg(
                                        src="https://media.licdn.com/dms/image/C4D12AQENxlEKXtt4Tw/article"
                                            "-cover_image-shrink_600_2000/0/1588295143025?e=2147483647&v=beta&t"
                                            "=3A_tBd2veQHzontm2NcuQ4lSuxL4lRNMeZJ8vw1MkOc",
                                        top=True,
                                        style={
                                            "opacity": 0.18,
                                            "height": "200px",
                    ...
                    dbc.Col(
                        [
                            dbc.Card(
                                [
                                    dbc.CardImg(
                                        src="https://thehustle.co/wp-content/uploads/2023/02/HS-News-Brief_2023-02"
                                            "-03T015826.025Z.png",
                                        top=True,
                                        style={
                                            "opacity": 0.18,
                                        ...
                                        dbc.CardBody(
                                            [
                                                ...
                                                dbc.Button(
                                                    "Explore",
                                                    color="dark",
                                                    href="https://rentalgpt.discovery.cs.vt.edu"
                    ...
                    dbc.Col(
                        [
                            dbc.Card(
                                [
                                    dbc.CardImg(
                                        src="https://huggingface.co/wordcab/llama-natural-instructions-7b/resolve"
                                            "/main/llama-natural-instructions-removebg-preview.png",
                                        top=True,
                                        style={
                                            "opacity": 0.18,
                                            "height": "200px",
