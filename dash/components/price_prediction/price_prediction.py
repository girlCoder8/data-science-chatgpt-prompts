            ...
            html.Div(
                [
                    html.Div(
                        [
                            html.Img(
                                src="https://images.unsplash.com/photo-1649393832219-0ad856a1e119?q=80&w=1170&auto"
        ...
        note = (
            html.Div(
                [
                    ...
                    html.P(
                        [
                            "Due to the lack of data and poor performance of the trained model, I have decided not to "
                            "deploy this tab. The demo can be seen on the right. General idea: The user will be able "
                            "to attach image(s), YOLOv5 will extract additional features of interests, which will ("
                            "hopefully) help the ML make a more accurate prediction. The code of the prototype can be "
                            "accessed ",
                            html.A(
                                "here",
                                href="your_image",
