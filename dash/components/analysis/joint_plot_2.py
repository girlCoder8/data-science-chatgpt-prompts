    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.P(
                        "The joint plot indicates a positive relationship between the number of bathrooms in a "
                        "property and its price, color-coded by interest level. While higher-priced listings tend to "
                        "have more bathrooms, the interest level doesn't seem exclusively higher for these "
                        "properties, which suggests that (known/unknown) factors other than the number of bathrooms "
                        "and price contribute to the interest level."
                    )
                ]
            ),
        ]
