    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.P(
                        "The bar chart indicates the interest level counts segmented by quarters. With only the "
                        "second quarter (summer) shown, there's a significant number of listings with low interest, "
                        "a moderate amount with medium interest, and relatively few with high interest."
                    )
                ]
            ),
        ]
