    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.P(
                        "The bar chart indicates the number of bathrooms in listings shows that one-bathroom units "
                        "are the most common, followed by two-bathroom units. Three or more bathrooms are relatively "
                        "rare. This pattern suggests that the housing market in New York city primarily adjusts to "
                        "singles and small families. Properties with a higher number of bathrooms are less common and "
                        "could potentially offer to a luxury market segment."
                    )
                ]
            ),
        ]
