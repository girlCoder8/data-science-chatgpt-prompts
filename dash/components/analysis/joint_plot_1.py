    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.P(
                        "The joint plot showcases the relationship between the price, the number of bedrooms, "
                        "and the interest level of listings. The scatter points are color-coded by interest level, "
                        "indicating that listings with high interest are not necessarily those with the highest price "
                        "or most bedrooms. It suggests that while there might be a trend for higher prices with more "
                        "bedrooms, the interest level is influenced by (known/unknown) factors beyond just these two."
                    )
                ]
            ),
        ]
