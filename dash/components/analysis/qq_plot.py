    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.P(
                        "The QQ plot of prices shows that the distribution of prices does not perfectly follow a "
                        "normal distribution, as the points does not directly fit with the red line, especially at "
                        "the lower and higher quantiles. This suggests that even after a log transformation (a "
                        "non-linear transformation), there are extreme values in the data. Indeed that 'prices' does "
                        "not follow the Gaussian (normal) distribution."
                    )
                ]
            ),
        ]
