            ...
            html.Div(
                [
                    html.P(
                        ...
                        "fluctuate throughout the month, with some days showing notable peaks in medium and low "
                        "interest. However, it seems like within the summer, the interest-levels are even throughout "
                        "the days in a month."
                    )
                ]
            ),
