    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.P(
                        "The pair plot indicates relationships between the number of bathrooms, bedrooms, and price. "
                        "There is a positive correlation between the number of bathrooms and bedrooms, "
                        "which is intuitive as larger homes tend to have more of both. The scatter plots also suggest "
                        "a positive correlation between price and both the number of bedrooms and bathrooms, "
                        "indicating that as the count of these features increases, so does the price."
                    )
                ]
            ),
        ]
