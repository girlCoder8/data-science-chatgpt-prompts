    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.P(
                        "The regression plot shows a positive correlation between the number of bathrooms in a "
                        "property and its price. As the number of bathrooms increases, the price also tends to rise. "
                        "However, the scatter plot reveals that most data points are concentrated at the lower end of "
                        "the bathroom count, with prices showing a wide range even for properties with the same "
                        "number of bathrooms. Most data points cluster at the lower end of both axes, indicating that "
                        "listings with fewer price and bathrooms are more common."
                    )
                ]
            ),
        ]
