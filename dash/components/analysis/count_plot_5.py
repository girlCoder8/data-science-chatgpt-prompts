    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.P(
                        "The bar chart shows the interest level counts across weekdays. It shows the lowest levels of "
                        "interest typically on the first day of the week and higher interest levels in the middle of "
                        "the week. The trend suggests that renters might be more actively looking for listings during "
                        "mid-week rather than at the beginning or end of the week."
                    )
                ]
            ),
        ]
