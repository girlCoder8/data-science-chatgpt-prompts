    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.P(
                        "The bar chart indicates the counts of interest levels for rental listings throughout "
                        "different hours of the day. There is a notable peak in activity during the early hours ("
                        "likely around midnight), with a high volume of low-interest levels. Interest levels is low "
                        "during early morning and start to rise again during work hours. Meanwhile, high interest is "
                        "high during night indicating serious renters are active"
                    )
                ]
            ),
        ]
