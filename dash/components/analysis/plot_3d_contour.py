    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.P(
                        "The 3D contour plot presents a visual representation of the relationship between the number "
                        "of bedrooms and bathrooms and the price of rental properties. Peaks in the contour suggest "
                        "that listings with a higher number of bedrooms and bathrooms tend to have higher prices. "
                        "This 3D view allows for ab understanding of how these variables interact. The steepness ("
                        "higher prices) in areas with more bathrooms indicates that bathrooms may have a stronger "
                        "influence on price in this dataset compared to bedrooms."
                    )
                ]
            ),
        ]
